        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="ms-auto me-2" style="width: 320px; max-width: 50vw;">
                    <input type="text" id="allPostsSearchInput" class="form-control form-control-sm"
                    ...
                    @forelse($allPosts as $post)
                        <a href="{{ route('post.show', $post->slug) }}"
                            ...
                            <div class="d-flex align-items-start">
                                <img src="{{ $post->image ? asset(ltrim($post->image, '/')) : 'https://picsum.photos/seed/' . $post->id . '/80/80' }}"
                                    alt="{{ $post->title }}" width="52" height="52" class="rounded me-3 flex-shrink-0"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-1 text-muted small">
                                        by <strong>{{ optional($post->user)->name ?? 'Unknown Admin' }}</strong>
                                    </p>
